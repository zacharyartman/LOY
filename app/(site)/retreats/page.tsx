...
const RetreatsPage = () => {
  return (
    <>
      <NewPageHero
        titleText={"Retreats"}
        link="/images/hero/retreats-yoga-near-me.webp"
      ></NewPageHero>
      <Details
...
`}
        images={[
          [
            "/images/retreats/retreat1.webp",
            "a rejuvenating retreat experience with yoga, meditation, and wellness activities hosted by Las Olas Yoga in a serene location",
          ],
          [
            "/images/retreats/retreat2.webp",
            "a rejuvenating retreat experience with yoga, meditation, and wellness activities hosted by Las Olas Yoga in a serene location",
          ],
          [
            "/images/retreats/retreat4.webp",
            "a rejuvenating retreat experience with yoga, meditation, and wellness activities hosted by Las Olas Yoga in a serene location",
          ],
          [
            "/images/retreats/retreat3.webp",
            "a rejuvenating retreat experience with yoga, meditation, and wellness activities hosted by Las Olas Yoga in a serene location",
          ],
          [
            "/images/retreats/retreat5.webp",
            "a rejuvenating retreat experience with yoga, meditation, and wellness activities hosted by Las Olas Yoga in a serene location",
          ],
        ]}
