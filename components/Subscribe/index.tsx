  ...
  return (
    <>
      ...
      >
        <div className="mb-7.5 flex flex-col gap-3">
          <input
            ...
            className={`w-full border-b ${errors.name ? "border-red-500" : "border-stroke"
              } bg-transparent pb-3.5 focus:border-waterloo focus:placeholder:text-black focus-visible:outline-none dark:border-strokedark dark:focus:border-manatee dark:focus:placeholder:text-white`}
          />
          <input
            type="email"
          ...
          <input
            ...
            name='phone'
            onChange={handleInputChange}
            className={`w-full border-b ${errors.phone ? "border-red-500" : "border-stroke"
              } bg-transparent pb-3.5 focus:border-waterloo focus:placeholder:text-black focus-visible:outline-none dark:border-strokedark dark:focus:border-manatee dark:focus:placeholder:text-white`}
          />
        </div>
        ...
        <input type="hidden" name="message" value="This user would like to be subscribed to the mailing list." />
