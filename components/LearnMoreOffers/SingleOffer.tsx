    ...
    <>
      ...
      <motion.a
        ...
        <div className="p-5.5 w-full">
          <p className={`text-primary text-center text-sectiontitle md:text-metatitle2 ${price ? "mb-1" : ""} line-clamp-2`}>
            {name}
          </p>
          {
            price && <p className="text-primaryho text-center text-metatitle md:text-metatitle3 ">{price}</p>
          }
