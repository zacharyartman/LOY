      ...
      <motion.a
        ...
        className={`animate_top w-full z-40 rounded-lg border border-none bg-lightestbrown shadow-solid-3 transition-all hover:shadow-solid-4 dark:border-strokedark dark:bg-blacksection dark:hover:bg-hoverdark`}>
          <div className="p-7.5 w-full">
            <p className={`text-primary text-sectiontitle md:text-metatitle2 ${price ? "mb-1" : ""} line-clamp-2`}>{name}</p>
            {
              price && <p className="text-primaryho text-metatitle md:text-metatitle3 ">{price}</p>
            }
