        ...
        <div className="mx-auto max-w-c-1235 px-4 md:px-8 xl:px-0">
          <div className="flex items-center gap-8 lg:gap-32.5">
            <motion.div
              ...
              viewport={{ once: true }}
              className="animate_left relative mx-auto hidden aspect-[200/150] md:block md:w-1/2"
            >
              <Image
        ...
        <div className="mx-auto max-w-c-1235 overflow-hidden px-4 md:px-8 2xl:px-0">
          <div className="flex items-center gap-8 lg:gap-32.5">
            ...
            <motion.div
              ...
              transition={{ duration: 1, delay: 0.1 }}
              viewport={{ once: true }}
              className="animate_right relative mx-auto hidden aspect-[200/150] md:block md:w-1/2"
            >
              <Image
